 ...
 *
 * RSC (Resource State Coordinator) register definitions for the nord
 * APSS RPMh controller, DRV0 (TZ) view.
 */
...
#define RSC_REG_BASE			(QTI_APSS_HM_BASE + 0x1900000U)
...
#define RSC_TCS_BASE_OFF		0xd20U
...
#define RSC_CMD_STRIDE			0x18U
#define RSC_CMD_BASE_OFF		0xd34U
